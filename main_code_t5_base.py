...
if checkpoint:
    ...
    model = T5ForConditionalGeneration.from_pretrained(MODEL_CS_CT5B)
...
training_args = TrainingArguments(
    ...
    eval_strategy='epoch',
    save_strategy='epoch',
    learning_rate=LR_CS_CT5B,
    per_device_train_batch_size=TRAIN_BATCH_SIZE_CS_CT5B,
    per_device_eval_batch_size=EVAL_BATCH_SIZE_CS_CT5B,
    num_train_epochs=NUM_TRAIN_EPOCHS_CS_CT5B,
    weight_decay=WEIGHT_DECAY_CS_CT5B,
    eval_accumulation_steps=EAS_CS_CT5B,
    torch_empty_cache_steps=TEC_CS_CT5B,
