...
train_dataset, val_dataset, test_dataset, tokenizer = prepare_dataset(TOKENIZER_CS_PLBARTJE, False)
...
EXPERIMENT_RESULTS_DIR = RESULTS_CS_DIR_PLBARTJE + EXPERIMENT_NAME
...
training_args = TrainingArguments(
    ...
    eval_strategy='epoch',
    save_strategy='epoch',
    learning_rate=LR_CS_PLBARTJE,
    per_device_train_batch_size=TRAIN_BATCH_SIZE_CS_PLBARTJE,
    per_device_eval_batch_size=EVAL_BATCH_SIZE_CS_PLBARTJE,
    num_train_epochs=NUM_TRAIN_EPOCHS_CS_PLBARTJE,
    weight_decay=WEIGHT_DECAY_CS_PLBARTJE,
    eval_accumulation_steps=EAS_CS_PLBARTJE,
    torch_empty_cache_steps=TEC_CS_PLBARTJE,
