...
MODEL_CS_PLBART = "uclanlp/plbart-base"
TOKENIZER_CS_PLBART = "uclanlp/plbart-base"
RESULTS_CS_DIR_PLBART = RESULTS_CS_DIR + "plbart/"

LR_CS_PLBART = 8e-5
TRAIN_BATCH_SIZE_CS_PLBART = 16
EVAL_BATCH_SIZE_CS_PLBART = 16
NUM_TRAIN_EPOCHS_CS_PLBART = 50
WEIGHT_DECAY_CS_PLBART = 0.01
EAS_CS_PLBART = 64
TEC_CS_PLBART = 32